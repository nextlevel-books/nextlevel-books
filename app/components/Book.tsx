        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-14 lg:gap-24 items-center text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-end order-1 md:order-none">
            <div className="relative group">
              ...
              {/*
                Weißer Rand-Crop: Das Bild hat rechts einen weißen Streifen (~3%).
                Lösung: overflow-hidden + das img leicht nach links verschieben
                und etwas breiter als der Container rendern.
              */}
              <div
                ...
                style={{
                  ...
                  aspectRatio: "2 / 3",
                  boxShadow:
                    "0 0 0 1px rgba(201,162,54,0.18), 0 28px 64px rgba(0,0,0,0.8), inset 0 0 0 1px rgba(0,0,0,0.4)",
                }}
              >
                <Image
                  src="/cover.png"
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-[#c9a236] hover:bg-[#d4b050] text-[#080d18] font-bold px-8 py-4 rounded-lg text-[11px] tracking-[0.25em] uppercase transition-all duration-200 hover:shadow-[0_0_28px_rgba(201,162,54,0.4)]"
            >
